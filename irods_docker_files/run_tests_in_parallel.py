...
def to_docker_commands(test_list, cmd_line_args):
    ...
    for test in test_list:
        ...
        if 'centos' in cmd_line_args.image_name:
            ...
            centosCmdBuilder.core_constructor(container_name, build_mount, upgrade_mount, results_mount, cgroup_mount, None, externals_mount, None, cmd_line_args.image_name, 'install_and_test.py', cmd_line_args.database_type, test, cmd_line_args.is_unit_test, database_container, docker_socket)
            ...
            ubuntuCmdBuilder.core_constructor(container_name, build_mount, upgrade_mount, results_mount, cgroup_mount, None, externals_mount, mysql_mount, cmd_line_args.image_name, 'install_and_test.py', cmd_line_args.database_type, test, cmd_line_args.is_unit_test, database_container, docker_socket)
...
def main():
    ...
    test_list = ['test_ils', 'test_irm', 'test_resource_types.Test_Resource_Replication_With_Retry.test_repl_retry_iput_valid']
    docker_cmds_list.extend(to_docker_commands(test_list, args))
