...
def setup_irods(database_type, zone_name):
    if zone_name == 'tempZone':
        if database_type == 'postgres':
            ...
            p = subprocess.check_call(['python /var/lib/irods/scripts/setup_irods.py < /other_zone.input'], shell=True)
...
def main():
    ...
    ci_utilities.install_irods_packages(args.database_type, args.install_externals, get_irods_packages_directory(), is_provider=True)
